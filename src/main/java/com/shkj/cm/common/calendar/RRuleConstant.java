package com.shkj.cm.common.calendar;
...
public class RRuleConstant {
     ...
     * 每天重复 - 在某个结束时间前
     */
    public  static final String REPEAT_CYCLE_DAILY_UNTIL_END_DATE = "FREQ=DAILY;INTERVAL=1;UNTIL=";

    /**
     * 每周重复 - 在某个结束时间前
     */
    public static final String REPEAT_CYCLE_WEEK_UNTIL_END_DATE = "FREQ=WEEKLY;INTERVAL=1;UNTIL=";

    /**
     * 每月重复 - 在某个结束时间前
     */

    public static final String REPEAT_CYCLE_MONTH_UNTIL_END_DATE = "FREQ=MONTHLY;INTERVAL=1;UNTIL=";

    /**
     * 每年重复 - 在某个结束时间前
     */
    public static final String REPEAT_CYCLE_YEAR_UNTIL_END_DATE = "FREQ=YEARLY;INTERVAL=1;UNTIL=";
