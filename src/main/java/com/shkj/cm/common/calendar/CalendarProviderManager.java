...
import static com.shkj.cm.common.calendar.Util.checkContextNull;
...
public class CalendarProviderManager {
    ...
    private static String CALENDAR_DISPLAY_NAME = "test";
...
//            case RRuleConstant.REPEAT_WEEKLY_BY_SU:
            case RRuleConstant.REPEAT_CYCLE_DAILY_UNTIL_END_DATE:
            case RRuleConstant.REPEAT_CYCLE_WEEK_UNTIL_END_DATE:
            case RRuleConstant.REPEAT_CYCLE_MONTH_UNTIL_END_DATE:
            case RRuleConstant.REPEAT_CYCLE_YEAR_UNTIL_END_DATE:
