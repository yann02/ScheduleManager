package com.shkj.cm.calendarview.bean;
...
//    private int colorLunar = Color.parseColor("#999999");//阴历的日期颜色
    private int colorLunar = Color.parseColor("#4DFFFFFF");//阴历的日期颜色
    private int colorHoliday = Color.parseColor("#EC9729");//节假日的颜色
//    private int colorChoose = Color.WHITE;//选中的日期文字颜色 #32C5FF
    private int colorChoose = Color.parseColor("#32C5FF");//选中的日期文字颜色
    private int sizeSolar = 14;//阳历日期文字尺寸
    private int sizeLunar = 8;//阴历日期文字尺寸
//    private int dayBg = R.drawable.blue_circle;//选中的背景
    private int dayBg = R.drawable.shape_of_selector_bg_of_calendar;//选中的背景
    private int currentDayBg = R.drawable.shape_of_current_bg_of_calendar;//当前日期的背景
    private Map<String, String> specifyMap;//指定日期对应的文字map
    private int chooseType = 0;//表示日历是0单选还是1多选

    public List<Integer> getArrayDot() {
        return arrayDot;
    }

    public void setArrayDot(List<Integer> arrayDot) {
        this.arrayDot = arrayDot;
    }

    public int getCurrentDayBg() {
        return currentDayBg;
    }

    public void setCurrentDayBg(int currentDayBg) {
